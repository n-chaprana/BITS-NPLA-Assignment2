...
class TestSentimentAnalysis(unittest.TestCase):
    ...
    def test_batch_analyze_sentiment(self):
        ...
        response = self.app.post('/api/batch-analyze',
...
class TestSentimentAnalyzer(unittest.TestCase):
    ...
    def test_analyze_sentiment_structure(self):
        ...
        expected_keys = ['neg', 'neu', 'pos', 'compound', 'sentiment_label', 'confidence', 'original_text', 'processed_text']
...
class TestSentimentAnalysisAdvanced(unittest.TestCase):
    ...
    def test_sentiment_analysis_cases(self):
        ...
        test_cases = [
            ...
            ("The service was fast and the staff was incredibly friendly.", "positive", "Simple Polarity"),
            ("I am extremely disappointed with the quality of the product.", "negative", "Simple Polarity"),
            ("The product arrived in a cardboard box.", "neutral", "Simple Polarity"),
            ("The movie was not bad at all; in fact, I quite enjoyed it.", "positive", "Negation"),
            ("I don't dislike the new update, but it takes time to get used to.", "positive", "Double Negative"),
            ("The hotel wasn't exactly clean.", "negative", "Soft Negation"),
            ("Oh great, another flight delay. This is exactly how I wanted to spend my Friday.", "negative", "Sarcasm"),
            ("I love it when my computer freezes right before I save my work.", "negative", "Sarcasm"),
            ("The food was delicious, but the prices were astronomical.", "neutral", "Aspect-Based"),
            ("The screen is beautiful; however, the battery life is pathetic.", "neutral", "Aspect-Based"),
            ("If only the customer support was as good as the marketing.", "negative", "Conditional"),
            ("This new phone is the goat!", "positive", "Slang"),
            ("The engine started making a sick sound.", "negative", "Context-Dependent"),
            ("The plot was a bit of a letdown.", "negative", "Idiomatic"),
            ("This laptop costs an arm and a leg.", "negative", "Idiomatic"),
            ("I've been waiting for ages for this to be fixed.", "negative", "Hyperbole")
        ]
